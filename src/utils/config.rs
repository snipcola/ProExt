...
pub struct Config {
    ...
    pub cross_hair: bool,
    pub cross_hair_color: (u32, u32, u32, u32),
    pub cross_hair_target_color: (u32, u32, u32, u32),
    pub cross_hair_outline: bool,
    pub cross_hair_dot: bool,
    pub cross_hair_dot_size: u32,
    pub cross_hair_circle: bool,
    pub cross_hair_circle_radius: u32,
    pub cross_hair_lines: bool,
    pub cross_hair_lines_width: u32,
    pub cross_hair_lines_height: u32,
    pub cross_hair_lines_space: u32,
    pub cross_hair_lines_thickness: u32,
    pub team_check: bool,
...
impl Default for Config {
    fn default() -> Self {
        return Config {
            ...
            trigger_bot: false,
            cross_hair: false,
            cross_hair_color: (0, 255, 0, 255),
            cross_hair_target_color: (255, 0, 0, 255),
            cross_hair_outline: true,
            cross_hair_dot: true,
            cross_hair_dot_size: 1,
            cross_hair_circle: false,
            cross_hair_circle_radius: 5,
            cross_hair_lines: true,
            cross_hair_lines_width: 6,
            cross_hair_lines_height: 6,
            cross_hair_lines_space: 8,
            cross_hair_lines_thickness: 1,
            team_check: true,
            visible_check: true,
            ground_check: true,
